(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AlbumInfoComponent = /** @class */ (function () {
                function AlbumInfoComponent(_data) {
                    this._data = _data;
                }
                return AlbumInfoComponent;
            }());
            AlbumInfoComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AlbumListComponent = /** @class */ (function () {
                function AlbumListComponent(_data, _function) {
                    this._data = _data;
                    this._function = _function;
                }
                AlbumListComponent.prototype.getAlbumTracks = function (index) {
                    this._function.getAlbumTracks(index);
                };
                return AlbumListComponent;
            }());
            AlbumListComponent.ctorParameters = function () { return [
                { type: src_app_services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ArtistProfileComponent = /** @class */ (function () {
                function ArtistProfileComponent(_data) {
                    this._data = _data;
                }
                return ArtistProfileComponent;
            }());
            ArtistProfileComponent.ctorParameters = function () { return [
                { type: src_app_services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CarrouselComponent = /** @class */ (function () {
                function CarrouselComponent(_function) {
                    this._function = _function;
                }
                CarrouselComponent.prototype.search = function (event) {
                    event.preventDefault();
                    var input = document.querySelector('#inputSearch').value;
                    this._function.getArtistAndAlbums(input);
                };
                return CarrouselComponent;
            }());
            CarrouselComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MusicPlayerComponent = /** @class */ (function () {
                function MusicPlayerComponent(_function) {
                    this._function = _function;
                }
                MusicPlayerComponent.prototype.getCurrentTrack = function () {
                    var track = this._function.getCurrentTrack();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavBarComponent = /** @class */ (function () {
                function NavBarComponent(_function) {
                    this._function = _function;
                }
                ...
                NavBarComponent.prototype.redirectHome = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TrackListComponent = /** @class */ (function () {
                function TrackListComponent(_data, _function) {
                    this._data = _data;
                    this._function = _function;
                    this._data.cache['current'].track = null;
                }
                TrackListComponent.prototype.setCurrentTrack = function (url) {
                    this._function.setCurrentTrack(url);
                };
                TrackListComponent.prototype.getDurationTrak = function (duration) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FunctionsService = /** @class */ (function () {
                function FunctionsService(router, _data) {
                    this.router = router;
                    this._data = _data;
                }
                FunctionsService.prototype.ajaxPromise = function (proxy, url) {
                ...
                ;
                FunctionsService.prototype.getArtistAndAlbums = function (input) {
                    var _this = this;
                    this.ajaxPromise(this._data.proxy, this._data.url + input)
                        ...
                        _this.router.navigateByUrl("/artist/" + data[0].artist.name);
                    })
                        .catch(function (err) { console.log(err); });
                };
                ;
                FunctionsService.prototype.getAlbumTracks = function (index) {
                    var _this = this;
                    var trackListUrl = this._data.cache['album'][index].tracklistUrl;
                    var albumTitle = this._data.cache['album'][index].title.match(/[\w\s\d]/gim).join('');
                    this._data.cache['current'].album = index;
                    this.ajaxPromise(this._data.proxy, trackListUrl)
                        .then(function (data) {
                        var cacheTemp = [];
                        _this._data.cache['album'][index].trackList = data.map(function (d) {
                        ...
                        _this._data.cache['current'].ready = true;
                        _this.router.navigateByUrl("/album/" + albumTitle);
                    })
                        .catch(function (err) { console.log(err); });
                };
                ;
                FunctionsService.prototype.getAlbumTracksByAlbumName = function (title) {
                    var _this = this;
                    this.ajaxPromise(this._data.proxy, this._data.url + ("album:\"" + title + "\""))
                        .then(function (data) {
                        var dafaultPic = "https://cdns-images.dzcdn.net/images/artist//500x500-000000-80-0-0.jpg";
                        var thisDefaultPic = "https://img.hebus.com/hebus_2003/12/30/preview/20031230132531_18.jpg";
                        if (data[0].artist.picture_big === dafaultPic)
                            data[0].artist.picture_big = thisDefaultPic;
                        var cacheTemp = [];
                        _this._data.cache['album'] = [];
                        _this._data.cache['current'].album = 0;
                        _this._data.cache['artist'] = {
                            id: data[0].artist.id,
                            name: data[0].artist.name,
                            image: data[0].artist.picture_big
                        ...
                        var trackListUrl = _this._data.cache['album'][0].tracklistUrl;
                        _this.ajaxPromise(_this._data.proxy, trackListUrl)
                            .then(function (data) {
                            _this._data.cache['album'][0].trackList = data.map(function (d) {
                ...
                ;
                FunctionsService.prototype.setCurrentTrack = function (url) {
                    this._data.cache['current'].track = url;
                };
                ;
                FunctionsService.prototype.getCurrentTrack = function () {
                    return this._data.cache['current'].track;
                };
                ;
                FunctionsService.prototype.redirectHome = function () {
                    this.router.navigateByUrl('/');
                };
                return FunctionsService;
            }());
            FunctionsService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ViewAlbumComponent = /** @class */ (function () {
                function ViewAlbumComponent(_data, _function, router, _path) {
                    this._data = _data;
                    this._function = _function;
                    this.router = router;
                    this._path = _path;
                ...
                ViewAlbumComponent.prototype.getterView = function () {
                    return this._data.cache['current'].ready;
                };
                return ViewAlbumComponent;
            }());
            ViewAlbumComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ViewArtistComponent = /** @class */ (function () {
                function ViewArtistComponent(_data, _function, router, _path) {
                    this._data = _data;
                    this._function = _function;
                    this.router = router;
                    this._path = _path;
            ...
            ViewArtistComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var ViewHomeComponent = /** @class */ (function () {
                function ViewHomeComponent() {
                }
                ViewHomeComponent.prototype.ngOnInit = function () {
                };
                return ViewHomeComponent;
            }());
